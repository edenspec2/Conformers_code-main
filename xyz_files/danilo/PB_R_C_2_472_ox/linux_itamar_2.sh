...
class LinuxCommands(Enum):
    ...
    CREST_SUFIX=' --xnam /gpfs0/gaus/projects/xtb-6.4.1/bin/xtb -ewin 10 --noreftopo'
...
if __name__=='__main__':
    os.chdir(r'/gpfs0/gaus/users/machadol/Kraken/Aim_prbi_complete/Phosph_ox/Cluster19/PB_R_C_2_472_ox')
    run_crest_calculation('PB_R_C_2_472_ox.xyz')
